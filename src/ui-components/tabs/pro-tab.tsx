              ...
              <Grid item>
                <ul style={{ listStyleType: "circle" }}>
                  ...
                  <li style={{ marginTop: 3 }}>
                    <Text>
                      Automatically send packing slips to fulfillment providers
                    </Text>
                  </li>
                  <li style={{ marginTop: 3 }}>
                    <Text>
                      Automatically detect the language of your customer
                    </Text>
                  </li>
                </ul>
              </Grid>
            ...
            <Grid container rowSpacing={3}>
              ...
              <Grid item>
                <ul style={{ listStyleType: "circle" }}>
                  <li>
                    <Text>
                      Access new premium templates for invoices and other
                      documents
                    </Text>
                  </li>
                  <li style={{ marginTop: 3 }}>
                    <Text>
                      Send us your custom template, and we will create it for
                      you
                    </Text>
                  </li>
                </ul>
            ...
            <Grid container rowSpacing={3}>
              ...
              <Grid item>
                <ul style={{ listStyleType: "circle" }}>
                  <li>
                    <Text>
                      Set different addresses for various document types
                    </Text>
                  </li>
                  <li style={{ marginTop: 3 }}>
                    <Text>
                      Customize settings for sending invoices to customers
                    </Text>
                  </li>
                  <li style={{ marginTop: 3 }}>
                    <Text>
                      Tailor settings for sending packing slips to fulfillment
                      providers
                    </Text>
                  </li>
                </ul>
