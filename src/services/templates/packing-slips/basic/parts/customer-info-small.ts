...
export function generateCustomerInformation(doc, y, order: Order) {
  ...
  if (order.billing_address) {
    ...
    doc
      .text(billAddress, 25, customerInformationTop + 30, { align: "left" })
      .moveDown();
  }
  ...
  if (order.shipping_address) {
    ...
    doc.text("Ship to:", RIGHT_MARGIN, customerInformationTop, {
      align: "right",
      width: RIGHT_WIDTH,
    });
    ...
    heightOfShipToAddress = doc.heightOfString(shipAddress, {
      width: RIGHT_WIDTH,
    });
    doc
      .text(shipAddress, RIGHT_MARGIN, customerInformationTop + 30, {
        align: "right",
        width: RIGHT_WIDTH,
      })
      .moveDown();
