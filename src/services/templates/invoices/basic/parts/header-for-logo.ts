...
export function generateHeaderForLogo(
  ...
  doc
    ...
    .fontSize(11)
    .font("Helvetica-Bold")
    .text(documentSettings.store_address.company, 50, 210, {
      align: "left",
      width: 250,
    })
    .font("Helvetica")
    ...
    .text(
      ...
      50,
      225,
      { align: "left", width: 225 }
    )
    .text("Email: care@terrapy.in", 50, 240, { align: "left" })
    .text("Mobile: 9090909090", 50, 255, { align: "left" })
    .text("GST: ABC123456789ABC", 50, 270, { align: "left" });
